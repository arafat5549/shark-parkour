...
- `自动`：检测到手机后，进入游戏自动请求/引导横屏
- `横屏`：始终引导横屏游玩
- `竖屏`：始终竖屏游玩

手机检测基于 UA + 触屏能力。系统允许时会自动调用屏幕方向锁定；若手机锁定竖屏，游戏会显示“请旋转为横屏”提示，也可选择继续竖屏游玩。
...
菜单页右滑（或点击“🛍️ 商店”按钮）打开商店，珍珠通过每局游戏获得并永久保存。
